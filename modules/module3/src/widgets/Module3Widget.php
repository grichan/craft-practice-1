...
namespace modules\module3\widgets;

use modules\module3\Module3;
use modules\module3\assetbundles\module3widgetwidget\Module3WidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class Module3Widget extends Widget
{
    ...
    {
        return Craft::t('module3', 'Module3Widget');
    }
    ...
    {
        return Craft::getAlias("@modules/module3/assetbundles/module3widgetwidget/dist/img/Module3Widget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'module3/_components/widgets/Module3Widget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(Module3WidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'module3/_components/widgets/Module3Widget_body',
            [
