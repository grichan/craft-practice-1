...
namespace modules\module3\fields;

use modules\module3\Module3;
use modules\module3\assetbundles\module3fieldfield\Module3FieldFieldAsset;
 ...
 * @since     1.0.0
 */
class Module3Field extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('module3', 'Module3Field');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'module3/_components/fields/Module3Field_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(Module3FieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').Module3Module3Field(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'module3/_components/fields/Module3Field_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
